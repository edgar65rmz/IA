    ...
    def actualizar_vecinos(self, grid):
        ...
        for dx, dy in direcciones:
            ...
            if 0 <= nuevo_fila < self.total_filas and 0 <= nuevo_col < self.total_filas:
                ...
                # Restricción para movimientos diagonales
                if abs(dx) == 1 and abs(dy) == 1:  # Es un movimiento diagonal
                    if grid[self.fila + dx][self.col].es_pared() or grid[self.fila][self.col + dy].es_pared():
                        continue  # No permitir movimiento diagonal a través de esquinas bloqueadas
        ...
        for vecino in actual.vecinos:
            ...
            if temp_g_score < vecino.g:
                ...
                if vecino not in open_set_hash:
                    ...
                    # Colorear como explorado
                    if vecino != fin:
                        vecino.color = ROJO

        dibujar()

        # Marcar el nodo actual como cerrado si no es inicio o fin
